...
%---------------------------------------------------------
    ...
    {\logo{Zego}{../../../images/zego.jpg} - Senior Java\,|\,Scala developer}
    {Luxembourg}
    {Nov 2021 - Aug 2022}
...
%---------------------------------------------------------
    ...
    {\logo{Slice}{../../../images/slice.png} - Senior Java\,|\,Scala developer}
    {Luxembourg}
    {Apr 2021 - Oct 2021}
...
%---------------------------------------------------------
    ...
    {\logo{Compare The Market}{../../../images/ctm.png} - Senior Java\,|\,Scala developer}
    {London}
    {Jan 2020 - Mar 2021}
...
%---------------------------------------------------------
    ...
    {\logo{The Guardian}{../../../images/guardian.png} - Senior Java\,|\,Scala developer}
    {London}
    {Oct 2018 - May 2019}
...
%---------------------------------------------------------
    ...
    {\logo{Sainsbury's}{../../../images/sainsburys.jpg} - Senior Java\,|\,Scala developer}
    {London}
    {Dec 2017 - Sep 2018}
...
%---------------------------------------------------------
    ...
    {\logo{Home Office (HMPO \& IPT)}{../../../images/ho.png} - Senior Java\,|\,Scala developer}
    {London}
    {June 2016 - Nov 2017}
...
%---------------------------------------------------------
    ...
    {\logo{HMRC (Valuation Office Agency)}{../../../images/voa.png} - Senior Java\,|\,Scala developer}
    {London}
    {Nov 2015 - May 2016}
    {The VOA is a government body that sets and enforces tax rates for private and business dwellings across the UK. I was tasked with re-designing the UI and data input processing, and interfacing data flows with legacy back-ends. }
...
%---------------------------------------------------------
    ...
    {\logo{Home Office (Border Force)}{../../../images/ho.png} - Senior Java\,|\,Scala developer}
    {London}
    {Mars 2014 - Oct 2015}
