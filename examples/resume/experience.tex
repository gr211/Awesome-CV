...
\begin{cventries}
    \cventry
    {\tagx{scala} \tagx{play} \tagx{mongodb} \tagx{api} \tagx{cqrs} \tagx{kafka} \tagx{k8s}}
...
%---------------------------------------------------------
    \cventry
    {\tagx{rust} \tagx{scala} \tagx{kafka} \tagx{etl} \tagx{kafka-streams} \tagx{ksql} \tagx{spark} \tagx{databricks} \tagx{dbt} \tagx{eks}}
...
%---------------------------------------------------------
    ...
    \cventry
    {\tagx{scala} \tagx{kafka} \tagx{etl} \tagx{ksql} \tagx{kafka-streams} \tagx{confluent} \tagx{databricks} \tagx{yarn}}
...
%---------------------------------------------------------
    \cventry
    {\tagx{scala} \tagx{kinesis} \tagx{etl} \tagx{api} \tagx{emr} \tagx{kafka-streams} \tagx{k8s} }
