...
\begin{cventries}
    \cventry
    {\tagx{scala} \tagx{play} \tagx{mongodb} \tagx{api} \tagx{cqrs} \tagx{angularjs}}
    {\logo{Groupe Foyer}{../../../images/foyer.png}$\sqbig$scala engineer}
    {Luxembourg}
    {Oct 2024 - present}
    {}
...
%---------------------------------------------------------
    ...
    \cventry
    {\tagx{scala} \tagx{http4s} \tagx{go} \tagx{api} \tagx{openid} \tagx{opentelemetry} \tagx{sso} \tagx{databricks}}
    {\logo{Disney streaming}{../../../images/disney.png}$\sqbig$scala engineer}
    {Luxembourg}
    {Oct 2022 - Sept 2024}
    {}
...
%---------------------------------------------------------
    \cventry
    {\tagx{scala} \tagx{java} \tagx{etl} \tagx{kafka-streams} \tagx{ksql} \tagx{spark}}
...
%---------------------------------------------------------
    ...
    \cventry
    {\tagx{scala} \tagx{java} \tagx{etl} \tagx{ksql} \tagx{kafka-streams} \tagx{confluent}}
    {\logo{Slice}{../../../images/slice.png}$\sqbig$scala\,|\,data engineer}
    {Luxembourg}
    {Apr 2021 - Oct 2021}
    {}
...
%---------------------------------------------------------
    \cventry
    {\tagx{scala} \tagx{java} \tagx{etl} \tagx{api} \tagx{emr} \tagx{spring boot} \tagx{kafka-streams}}
    {\logo{Compare The Market}{../../../images/ctm.png}$\sqbig$scala\,|\,data engineer}
    {London}
    {Jan 2020 - Mar 2021}
    {}
...
%---------------------------------------------------------
    \cventry
    {\tagx{scala} \tagx{java} \tagx{etl} \tagx{kafka-streams} \tagx{ksql} \tagx{redshift} \tagx{rabbitmq}}
    {\logo{Depop}{../../../images/depop.jpg}$\sqbig$scala\,|\,data engineer}
    {London}
    {June 2019 - Dec 2019}
    {}
...
%---------------------------------------------------------
    \cventry
    {\tagx{scala} \tagx{java} \tagx{etl} \tagx{api} \tagx{emr} \tagx{kafka-streams}}
    {\logo{The Guardian}{../../../images/guardian.png}$\sqbig$scala\,|\,data engineer}
    {London}
    {Oct 2018 - May 2019}
    {}
...
%---------------------------------------------------------
    \cventry
    {\tagx{scala} \tagx{java} \tagx{etl} \tagx{cloudera} \tagx{kerberos} \tagx{hive} \tagx{kafka-streams}}
...
%---------------------------------------------------------
    ...
    {\logo{Home Office (HMPO \& IPT)}{../../../images/ho.png}$\sqbig$scala engineer}
    {London}
    {June 2016 - Nov 2017}
    {}
...
%---------------------------------------------------------
    ...
    {\logo{HMRC (Valuation Office Agency)}{../../../images/voa.png}$\sqbig$scala engineer}
    {London}
    {Nov 2015 - May 2016}
    {}
...
%---------------------------------------------------------
    ...
    {\logo{Home Office (Border Force)}{../../../images/ho.png}$\sqbig$java\,|\,scala engineer}
    {London}
    {Mar 2014 - Oct 2015}
    {}
